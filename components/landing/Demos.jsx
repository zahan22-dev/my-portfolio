        ...
        <div className=" container3x  ontop">
            ...
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/smart-calc.png" alt="" />
                </div>
                <h6>01 | Main Home</h6>
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/idioms.png" alt="" />
                </div>
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/adwolf.png" alt="" />
                </div>
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/tespire.png" alt="" />
                </div>
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/burqora.png" alt="" />
                </div>
                <h6>05 | Freelancer</h6>
          ...
          <div className="carddx">
            <div className="items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/salesflo.png" alt="" />
                </div>
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <img src="/landing-preview/img/demos/myzoi.png" alt="" />
                </div>
